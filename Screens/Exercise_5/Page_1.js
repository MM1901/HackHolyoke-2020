...
function Page_1(props) {
    ...
    return (
        <SafeAreaView style={styles.container} >
            <Text style={styles.bigText}>Breathe. Everything is okay. What's on your mind?</Text>
            <TextInput style={styles.input} onChangeText={text => setText(text)} placeholder="I have to..." />
